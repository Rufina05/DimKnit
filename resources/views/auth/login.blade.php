      ...
      <div class="flex items-start justify-center p-6 sm:p-12 lg:p-16 bg-gray-50">
        <div class="w-full max-w-xl bg-white rounded-2xl p-8 sm:p-12 mt-16">
          ...
          <form action="{{ route('login.post') }}" method="POST" class="space-y-8">
            ...
            <div>
              <input type="password" name="password" placeholder="Password" required class="w-full px-4 py-3 sm:px-5 sm:py-4 border-0 border-b-2 border-gray-200 bg-gray-50 text-sm sm:text-base placeholder-gray-400 focus:border-red-600 focus:ring-0 focus:outline-none transition-all duration-200">
