        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden lg:flex items-center space-x-6 mx-auto">
                    <a href="{{ route('catalog') }}" wire:navigate 
                       class="px-4 py-2.5 text-base font-medium text-gray-800 rounded-full hover:text-red-900 transition">
                       Catalog
                    </a>
                ...
                <div class="hidden lg:flex items-center gap-6">
                    ...
                    <div class="flex items-center gap-2 p-2.5 rounded-md bg-gray-100">
                        <input 
                            ...
                            type="text" 
                            placeholder="Search..."
                            class="text-black/60 text-sm px-3 py-1.5 bg-gray-100 focus:outline-none"
                        >
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        @auth
                            <a href="{{ route('heart') }}" wire:navigate 
                               class="hover:text-red-800 transition">
                        ...
                        @else
                            <a href="{{ route('login') }}" wire:navigate 
                               class="text-gray-800 font-medium hover:text-red-800 transition">
                                Login
                            </a>
                        @endauth
                ...
                <div class="flex lg:hidden">
                    <button @click="expanded = !expanded" 
                            class="p-2.5 text-gray-900 rounded-full border border-gray-900 hover:bg-gray-900 hover:text-white transition">
            ...
            <nav 
                x-show="expanded"
                x-transition
                class="mt-4 pt-6 pb-6 bg-white border border-gray-200 rounded-md shadow-md lg:hidden"
            >
                <div class="flex flex-col px-6 space-y-4">

                    <a href="{{ route('catalog') }}" wire:navigate 
                       class="text-base font-medium text-gray-900 hover:text-red-00">
                       Catalog
                    </a>
                    ...
                    <div class="flex items-center gap-2 p-3 bg-gray-100 rounded-xl">
                        <input id="search-mobile" type="text" placeholder="What are you looking for?" 
                               class="w-full text-sm text-black/60 px-3 py-2 rounded-md bg-gray-100 focus:outline-none">
                    ...
                    @auth
                        ...
                        <a href="{{ route('account') }}" class="flex items-center gap-2 hover:text-red-00">
