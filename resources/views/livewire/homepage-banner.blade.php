  ...
  <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 sm:grid-cols-2 items-stretch gap-8 sm:gap-12 min-h-[80vh]">
      ...
      <div class="flex flex-col justify-center text-center lg:text-left space-y-6 lg:space-y-8">
        ...
        <!-- Button: ширина под текст + иконку -->
        <a href="{{ route('catalog') }}" wire:navigate 
           class="inline-flex items-center px-6 py-4 font-semibold text-white bg-red-900 rounded-full hover:text-red-200 focus:text-red-200 w-max transition-colors duration-200"
           role="button">
          Shop Now
      ...
      <div class="flex justify-center lg:justify-end items-center w-full">
        <img 
          ...
          src="{{ asset('storage/banners/hero.png') }}" 
          alt="Hero Image" 
        />
      </div>
